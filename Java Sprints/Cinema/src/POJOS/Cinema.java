...
public class Cinema  implements java.io.Serializable {
    ...
    public Cinema(int cinemaId, String name, String province, String location) {
        this.cinemaId = cinemaId;
        this.name = name;
        this.province = province;
        this.location = location;
    }
    public Cinema(int cinemaId, String name, String province, String location, Set managerses, Set bookingses) {
       this.cinemaId = cinemaId;
       this.name = name;
       this.province = province;
       this.location = location;
